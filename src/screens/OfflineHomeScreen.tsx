    ...
    <View style={{ flex: 1 }}>
      <View style={{ backgroundColor: '#1f2937', paddingVertical: 6, alignItems: 'center' }}>
        <Row gap={6}>
          ...
          <T size={11} color="#fbbf24" weight="b">অফলাইন মোড সক্রিয়</T>
        </Row>
      </View>
      <AppHeader
        title={
      ...
      <ScreenScroll>
        ...
        <Card leftBar={colors.saffron} style={{ padding: 16, marginTop: 18, marginBottom: 12, backgroundColor: '#fff8ec' }}>
          <Row gap={8}>
            <T size={22}>💰</T>
          ...
          <Btn label="বিক্রি যোগ করুন" full style={{ marginTop: 14 }} onPress={onOpenSale} iconLeft={<Ionicons name="add" size={18} color="#fff" />} />
        </Card>
        ...
        <Card leftBar={colors.amber} style={{ padding: 16, marginBottom: 12 }}>
          ...
          <Btn kind="amberOutline" label="প্রস্তুতি দেখুন" full style={{ marginTop: 14 }} onPress={onOpenHaat} iconRight={<Ionicons name="arrow-forward" size={16} color={colors.amber} />} />
        </Card>
        ...
        <Card leftBar={colors.coral} style={{ padding: 16, marginBottom: 12 }}>
          ...
          <Btn kind="coralOutline" label="কাস্টমার খাতা" full style={{ marginTop: 14 }} onPress={onOpenLedger} iconRight={<Ionicons name="arrow-forward" size={16} color={colors.coral} />} />
        </Card>

        <Card leftBar={colors.teal} style={{ padding: 16, marginBottom: 12, backgroundColor: '#f0fdfa' }}>
          <Row gap={8}>
            <SathiBadge />
          ...
          <View style={{ height: 10, backgroundColor: '#e4f4f1', borderRadius: 5, marginTop: 12, overflow: 'hidden' }}>
            <View style={{ width: '17%', height: '100%', backgroundColor: colors.teal, borderRadius: 5 }} />
          </View>
          ...
          <Btn kind="teal" label="সাথীর সাহায্য নিন" full style={{ marginTop: 12 }} onPress={onOpenJourney} iconRight={<Ionicons name="arrow-forward" size={16} color="#fff" />} />
        </Card>
        ...
        <Card tinted={colors.tealSoft} style={{ padding: 14 }}>
          ...
          <Card style={{ padding: 10, marginTop: 10, backgroundColor: 'rgba(255,255,255,0.7)', borderColor: 'transparent' }}>
            <Row gap={8}>
              <SathiBadge size={16} />
              <T size={12.5}>হিসাব লিখলে PKSF ঋণ পাওয়া সহজ হয়</T>
            </Row>
          </Card>
        </Card>
      </ScreenScroll>
